(function() {
    ...
    toolbar.innerHTML = '<div style="display:flex;flex-direction:column;"><span style="font-weight:bold;color:#fff;font-size:14px;text-shadow:0 0 5px ' + greenGlow + ';">ROOT@TERMINAL</span><span style="font-size:8px;color:' + greenGlow + ';opacity:0.7;">ADS_BYPASS: READY</span></div>';
